...
class Dataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        data['images_a'] = [transform_cartoons(data['images_a'][0])]
        data['images_b'] = [transform_faces(data['images_b'][0])]
        # Apply ops pre augmentation.
        #change here with resize from our code
        ...
        # Package output.
        data['is_flipped'] = False #is_flipped
